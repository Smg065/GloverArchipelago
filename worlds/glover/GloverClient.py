...
steam_patch_md5: str = "6809ef4cffedf4329f1d5262e51a1869"
    ...
    def __init__(self, server_address, password):
        ...
        self.link_table : dict[str, Link] = {
            ...
            "TRAP" : MultiLink("TRAP", "TrapLink", {
                "FROG" : {"Accepts" : ["Animal Trap", "Animal Bonus Trap", "Blastoad", "Fishing Trap", "Frog Trap", "Furry Convention Trap", "Jump Trap", "Jumping Jacks Trap", "Leaping Trap", "No Guarding", "Paratoad", "Poisontoad", "Shrink Trap", "Sleeptoad", "Snake Trap", "Slow Trap", "Slowness Trap", "Stinky Trap", "Tiny Trap"]},
                "CRYSTAL" : {"Accepts" : ["Chameleos Spit", "Cursed Trap", "Crystal Trap", "Damage Trap", "Double Damage", "Eject Ability", "Energy Drain Trap", "Gadget Shuffle Trap", "Items to Bombs", "Instant Crystal Trap", "One Hit KO", "One Hit Trap", "Radiation Trap", "Sudden Trap", "Swap Trap", "Whoops! Trap"]},
                "CAMERA" : {"Accepts" : ["Camera Trap", "Camera Rotate Trap", "Confound Trap", "Confuse Trap", "Deisometric Trap", "Flip Horizontal Trap", "Flip Trap", "Flip Vertical Trap", "Gas Trap", "Inverted Mouse Trap", "Mirror Trap", "Reverse Controls Trap", "Reversal Trap", "Reverse Trap", "Screen Flip Trap", "Whirlpool Trap"]},
                "CURSE_BALL" : {"Accepts" : ["Curse Trap", "Banana Peel Trap", "Banana Trap", "Blue Balls Curse", "Confusion Trap", "Controller Drift Trap", "Cursed Ball Trap", "Ice Floor Trap", "Ice Trap", "Monkey Mash Trap", "My Turn! Trap", "Puppet Spider", "Shake Trap", "Slip Trap"]},
                "TIP" : {"Accepts" : ["Aaa Trap", "Burger Hat Trap", "Cutscene Trap", "E. Gadd Ramblings", "Employee Training Trap", "Exposition Trap", "Ghost Chat", "Help Trap", "Hey! Trap", "Literature Trap", "OmoTrap", "Person Trap", "Phone Trap", "Research Trap", "Tip Trap", "Trivia Trap", "Tutorial Trap", "Spam Trap", "Well Done Trap", "Yap Trap"]},
                "FISH_EYE" : {"Accepts" : ["144p Trap", "CRT Trap", "Fish Eye Trap", "Food Poisoning Trap", "Fracture Trap", "Fuzzy Trap", "Isometric Trap", "Pixelate Trap", "Pixellation Trap", "PSP Trap", "Spotlight Trap", "Underwater Trap", "Vintage Trap", "W I D E Trap", "Zoom In Trap", "Zoom Out Trap", "Zoom Trap"]},
                "ENEMY_BALL" : {"Accepts" : ["Army Trap", "Bee Trap", "Bunyon Trap", "Chaos Trap", "Employee Hiring Trap", "Fear Trap", "Gooey Bag", "Modified Bloons Trap", "Police Trap", "Spooky Time", "Syntax Jumpscare Trap", "Tarr Trap", "Thwimp Trap"]},
                "CONTROL_BALL" : {"Accepts" : ["Bald Trap", "Blango Artillery", "Breakout Trap", "Bubble Trap", "Control Ball Trap", "Disable A Trap", "Disable Z Trap", "Ghost", "Pinball Trap", "PONG Challenge", "Pong Trap"]},
                "INVISIBALL" : {"Accepts" : ["Clear Image Trap", "Depletion Trap", "Disable B Trap", "Disarm Trap", "Empty Item Box Trap", "Fishin' Boo Trap", "Get Out Trap", "Hidden Trap", "Invisiball Trap", "Invisible Trap", "Invisibility Trap", "No Hat Trap", "No Stocks", "No Vac Trap", "Resistance Trap", "Spike Ball Trap"]},
                #Misc items activated by traps
                "STICKY" : {"Accepts" : ["Honey Trap", "Iron Boots Trap", "Sticky Floor Trap", "Sticky Hands Trap", "Tar Trap"]},
                "SPEED" : {"Accepts" : ["Fast Trap", "Speed Up Trap"]},
                "LOW_GRAVITY" : {"Accepts" : ["Gravity Trap"]},
                #Dev Items activated by traps
                #"DEATH" : {"Accepts" : ["Instant Death Trap"]},
                "TAG" : {"Accepts" : ["Tool Swap Trap", "Transmute Trap"]},
