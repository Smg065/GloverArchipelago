...
function received_events(itemId)
	...
	elseif itemId == 6500075 then
        if TOTAL_PROGRESSIVE_LEVEL_EVENTS["AP_PREHISTORIC_L3_PROGRESSIVE_LOWER_MONOLITH"] < 4 then
            TOTAL_PROGRESSIVE_LEVEL_EVENTS["AP_PREHISTORIC_L3_PROGRESSIVE_LOWER_MONOLITH"] = TOTAL_PROGRESSIVE_LEVEL_EVENTS["AP_PREHISTORIC_L3_PROGRESSIVE_LOWER_MONOLITH"] + 1
            GVR:setItem(ITEM_TABLE["AP_PREHISTORIC_L3_PROGRESSIVE_LOWER_MONOLITH"], TOTAL_PROGRESSIVE_LEVEL_EVENTS["AP_PREHISTORIC_L3_PROGRESSIVE_LOWER_MONOLITH"])
        end
	...
	elseif itemId == 6500076 then
		TOTAL_PROGRESSIVE_LEVEL_EVENTS["AP_FORTRESS_L1_PROGRESSIVE_DOOR"] = TOTAL_PROGRESSIVE_LEVEL_EVENTS["AP_FORTRESS_L1_PROGRESSIVE_DOOR"] + 1
	    GVR:setItem(ITEM_TABLE["AP_FORTRESS_L1_PROGRESSIVE_DOOR"], TOTAL_PROGRESSIVE_LEVEL_EVENTS["AP_FORTRESS_L1_PROGRESSIVE_DOOR"])
	elseif itemId == 6500092 then
	    GVR:setItem(ITEM_TABLE["AP_FORTRESS_L1_COFFIN_LIGHTNING"], 1)
	...
	elseif itemId == 6500095 then
		TOTAL_PROGRESSIVE_LEVEL_EVENTS["AP_FORTRESS_L2_PROGRESSIVE_GATE"] = TOTAL_PROGRESSIVE_LEVEL_EVENTS["AP_FORTRESS_L2_PROGRESSIVE_GATE"] + 1
	    GVR:setItem(ITEM_TABLE["AP_FORTRESS_L2_PROGRESSIVE_GATE"], TOTAL_PROGRESSIVE_LEVEL_EVENTS["AP_FORTRESS_L2_PROGRESSIVE_GATE"])
